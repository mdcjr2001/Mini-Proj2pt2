    ...
    <div className="feed">
      <div className="head">
        <div className="user">
          ...
          <div className="info">
            <h3>NFL</h3>
            <small>New York City, New York 8 Hours Ago</small>
          </div>
        </div>
        <span className="edit">
      ...
      <div className="photo">
        <img src="https://static.clubs.nfl.com/image/private/t_new_photo_album/cowboys/khn8ktltzgqopglmruse.jpg" />
      </div>
      ...
      <div className="liked-by">
        <p>
          Liked by <b>Stephen Moss</b> and <b>4,695 others</b>
        </p>
      </div>
      <div className="caption">
        <p>
          <b>nfl</b> America's Team PreGame Huddle
        </p>
      </div>
      <div className="comments text-muted">View all 820 comments</div>
    </div>
  </div>
